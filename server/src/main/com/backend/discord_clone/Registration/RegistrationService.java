 ...
 */
    ...
    /**
     * Boiler plate confirmation email format. 
     * @param name Name of the appUser. 
     * @param link Link with token to enable account.
     * @return Returns a custom email with verification link.
     */
